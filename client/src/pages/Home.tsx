...
const copy = {
  ar: {
    ...
    aboutDescription: "تجمع منصة يمن سانكشن بين تقنيات البحث الذكي وإجراءات التدقيق لتقديم تجربة فحص واضحة للجهات المصرفية والقطاع الخاص.",
    values: [
    ...
    footer: "© 2026 منصة يمن سانكشن. جميع الحقوق محفوظة.",
