...
- [ ] إعداد خطوات ربط الموقع بـ Google Search Console وطلب الفهرسة
- [ ] التحقق من التحسينات وحفظ checkpoint

## Phase 53: اتساق البحث في الأسماء التجارية العربية
- [ ] إعادة إنتاج فرق البحث بين «شركة سويد للصرافة» و«سويد للصرافة»
- [ ] تشخيص مسار التطبيع واسترجاع المرشحين دون تعديل بيانات أو معرفات السجلات
- [ ] تصميم إصلاح محافظ للكلمات الوصفية التجارية في الاستعلام
- [ ] إضافة اختبارات للصيغتين العربية والإنجليزية والتحقق من النتائج الحية
- [ ] حفظ checkpoint للإصلاح
